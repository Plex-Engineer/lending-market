...
contract ComptrollerKovan is Comptroller {
    function getWCantoAddress() override public pure returns (address) {
...
contract ComptrollerHarness is Comptroller {
    ...
    //change compAccrued to wcantoAccrued
    function setWCantoAccrued(address user, uint userAccrued) public {
        compAccrued[user] = userAccrued;
    }

    function setWCantoAddress(address wcantoAddress_) public {
        wcantoAddress = wcantoAddress_;
    }

    function getWCantoAddress() override public view returns (address) {
        return wcantoAddress;
    }
